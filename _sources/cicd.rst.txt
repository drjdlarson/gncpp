...
The first that runs on every push is designed to build the code in both release and debug confiugrations then run the unit tests. If the tests fail, you can look at the workflow log to see the output from the failing test cases.
