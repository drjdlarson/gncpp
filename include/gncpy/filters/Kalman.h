...
class Kalman : public IBayesFilter {
   ...
   public:
     ...
     *
     * This can either set the constant measurement matrix, or the matrix
     * can be time varying. This assumes a measurement model of the form
     *
     * \f[
   ...
   private:
    ...
    void serialize(Archive& ar, [[maybe_unused]] const unsigned int version) {
        ...
        ar & m_dynObj;
        ar & m_measObj;
        // ar& boost::serialization::base_object<dynamics::ILinearDynamics>(
        //     m_dynObj);
        // ar&
        // boost::serialization::base_object<measurements::ILinearMeasModel>(
        //     m_measObj);
    }

    Eigen::MatrixXd m_measNoise;

    boost::shared_ptr<dynamics::ILinearDynamics> m_dynObj;
    boost::shared_ptr<measurements::ILinearMeasModel> m_measObj;
